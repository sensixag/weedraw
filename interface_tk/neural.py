...
class NeuralFunctions():
    ...
    def ellipse_overlap(self, image, x_center, y_center, length_x, length_y, angle=0, color=(255,255,255), thickness=-1):
        """
